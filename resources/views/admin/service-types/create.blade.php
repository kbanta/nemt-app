...
<div class="page-header">
    <div>
        ...
        <p>Define a new transport service with its pricing structure</p>
    </div>
        ...
        <div class="form-body">
            ...
            <div class="field">
                ...
                <textarea
                    id="description"
                    name="description"
                    placeholder="Optional — briefly describe what this service includes…">{{ old('description') }}</textarea>
